...
CREATE TABLE IF NOT EXISTS mobil (
    ...
    tipe VARCHAR(100),
    tahun INTEGER,
    transmisi VARCHAR(50) DEFAULT 'Automatic',
    kapasitas INTEGER DEFAULT 5,
    "bahanBakar" VARCHAR(50) DEFAULT 'Bensin',
    warna VARCHAR(50),
    "hargaSewa" NUMERIC(15, 2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS bookings (
    ...
    "jamMulai" VARCHAR(20) DEFAULT '08:00',
    "jamSelesai" VARCHAR(20) DEFAULT '17:00',
    "durasiHari" INTEGER NOT NULL DEFAULT 1,
    "hargaPerHari" NUMERIC(15, 2) NOT NULL DEFAULT 0,
    "totalHarga" NUMERIC(15, 2) NOT NULL DEFAULT 0,
    deposit NUMERIC(15, 2) DEFAULT 0,
    "sisaBayar" NUMERIC(15, 2) DEFAULT 0,
    status VARCHAR(50) NOT NULL DEFAULT 'Booking',
    "metodeBayar" VARCHAR(50) DEFAULT 'Transfer Bank',
    catatan TEXT,
    created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP
);
